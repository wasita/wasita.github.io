			...
			<div class="block lg:pl-12">
				...
				<div class="mt-4">
					...
					<a
						...
						href=""
						target="_blank"
						rel="noreferrer">github repo (private)</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="items-center block lg:flex">
		...
		<div class="flex-1">
			<div class="block lg:pl-12">
				...
				<h3>contributor (2022-present)</h3>
				<div class="py-2">
					<span class="chip variant-soft-primary">
				...
				<p>
					created a way for users to search and filter through the women in network science society members database.
				</p>
				<div class="mt-4">
					<a
						class="btn variant-glass-primary"
						...
						target="_blank"
						rel="noreferrer">visit members database</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="block lg:pl-12">
				...
				<div class="mt-4">
					<a
						...
						target="_blank"
						rel="noreferrer">visit darbrains</a>
					<a
						class="btn variant-glass-secondary"

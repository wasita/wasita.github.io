...
<div
	...
	<div class="flex flex-col-reverse lg:flex-row">
		...
		<img src="images/wasi_icon.jpg" alt="wasita" class="object-cover w-2/3 mb-10 mx-auto transition-opacity duration-300 ease-in-out rounded-full hover:opacity-70 lg:w-1/4" />
	</div>
</div>
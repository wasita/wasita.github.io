...
<article class="px-6 lg:px-12 pt-12 pb-20 max-w-5xl mx-auto">
  ...
  <!-- Bio prose -->
  <div
    class="font-body text-lg leading-relaxed space-y-5"
    style="color: var(--ink);"
  >
    <p>
      <span class="lab-logo-row">
        <a
          href="https://codec-lab.github.io/"
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-left mr-4 mt-1 w-24"
          aria-label="CoDec Lab"
        >
          <img
        ...
        <a
          href="https://sinclaboratory.com/"
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-right ml-4 mt-1 w-28"
          aria-label="SINC Lab"
        >
          <img
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer">Center for Computational Psychiatry</a
      >
      at the Icahn School of Medicine at Mt. Sinai, working with
      <a href="https://markkho.github.io/" target="_blank" rel="noreferrer"
        >Mark Ho</a
      >
      and
      <a href="https://shawnrhoadsphd.com/" target="_blank" rel="noreferrer"
        >Shawn Rhoads</a
      >, respectively.
    </p>
    ...
    <p style="clear: both;">
      <span class="lab-logo-row">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-left mr-4 mt-1 w-28"
          aria-label="COSAN Lab"
        >
          <img
        ...
        <a
          href="https://social-interaction-lab.org/"
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-right ml-4 mt-1 w-28"
          aria-label="Social Interaction Lab"
        >
          <img
      ...
      I completed my PhD in Cognitive Neuroscience at Dartmouth in summer 2026, where
      I worked with
      <a
        href="https://pbs.dartmouth.edu/people/luke-j-chang"
        target="_blank"
        rel="noreferrer">Luke Chang</a
      >
      in the
      ...
      <a
        href="https://profiles.stanford.edu/robert-hawkins"
        target="_blank"
        rel="noreferrer">Robert Hawkins</a
      >, who runs the
      <a
        href="https://social-interaction-lab.org/"
        target="_blank"
        rel="noreferrer">Social Interaction Lab</a
      >
      at Stanford, and
      <a
        href="https://faculty-directory.dartmouth.edu/jonathan-s-phillips"
        target="_blank"
        rel="noreferrer">Jonathan Phillips</a
    ...
    <p style="clear: both;">
      <span class="lab-logo-row">
        <a
          href="https://www.lnccbrown.com/"
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-left mr-4 mt-1 w-24"
          aria-label="LNCC Brown"
        >
          <img
        ...
        <a
          href="https://www.shenhavlab.org/"
          target="_blank"
          rel="noreferrer"
          class="lab-logo float-right ml-4 mt-1 w-32"
          aria-label="Shenhav Lab"
        >
          <img
      ...
      <a href="https://ski.clps.brown.edu/" target="_blank" rel="noreferrer"
        >Michael J. Frank</a
      >'s
      ...
      decisions under uncertainty, particularly in psychiatric contexts, with a
      focus on OCD. Before that, I worked as an undergraduate research assistant
      in
      <a href="https://www.shenhavlab.org/" target="_blank" rel="noreferrer"
        >Amitai Shenhav's Lab</a
      >, where I studied performance monitoring and cognitive control during
      task-switching.
    </p>

    <p style="clear: both;">
      <span
        class="float-right ml-6 mb-2 text-center hidden sm:flex flex-col items-center"
        style="margin-top: 0.25rem;"
      >
        <span class="margin-note mb-4" style="transform: rotate(-3deg);"
          >life beyond the lab ↓</span
        >
        <span class="taped-photo glittery" style="transform: rotate(2.5deg);">
          <img
            ...
            height="213"
            loading="lazy"
            class="block w-36 h-auto object-cover"
          />
        </span>
      </span>
      I was born in Thailand, grew up in Maine, and then lived in Rhode Island for
      several years for college and work. Outside of research, I enjoy ruminating
      while showering, snowboarding, cuddling with my kitty Joji (pictured above),
      and playing video games (currently
      <a
        href="https://www.youtube.com/watch?v=2p-5RXAitTI"
        target="_blank"
        rel="noreferrer">Baldur's Gate 3</a
      >,
      <a
        href="https://www.youtube.com/watch?v=xj-MRvcXHgw"
        target="_blank"
        rel="noreferrer">Elden Ring</a
      >, and
      <a
        href="https://www.youtube.com/watch?v=ttVtllHkb4E"
        target="_blank"
        rel="noreferrer">Slay the Spire 2</a
  ...
  <!-- Sign-off -->
  <p
    class="margin-note text-right mt-12"
    style="clear: both; transform: rotate(-2deg); font-size: 1.6rem;"
  >
    xoxo wasita <span
      class="sparkle"
      aria-hidden="true"
      style="width: 0.55em; height: 0.55em; margin-left: 0.15em; vertical-align: 0.1em;"
    ></span>
  </p>
</article>

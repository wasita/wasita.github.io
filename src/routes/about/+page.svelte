...
<article class="px-6 lg:px-12 pt-12 pb-20 max-w-5xl mx-auto">
 ...
 <h1 class="font-display flex-shrink-0" style="font-size: clamp(3rem, 9vw, 6.5rem); line-height: 0.95; margin: 0;">
 about
 ...
 <div class="taped-photo glittery flex-shrink-0 mb-3" style="transform: rotate(4deg);">
 <img
 ...
 <h1 class="font-display md:hidden mb-8" style="font-size: clamp(3rem, 9vw, 6.5rem); line-height: 0.95;">
 about

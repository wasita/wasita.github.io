...
I wasn't president, but I worked closely with the people who were, and each brought a distinct management style. Some were assertive and structured, quick to make executive decisions and keep things on schedule. Others were more easygoing and collaborative, creating space for input and flexibility, even if it slowed things down. I saw firsthand how those choices impacted morale, participation, and overall club efficiency. Too much rigidity could burn people out; too little direction could stall momentum. The most effective leaders found a balance, or at least knew how to adapt based on the situation.

Just like club presidents, PIs vary widely in how they manage people and projects. Learning how to work under (and around) different styles has helped me navigate research environments with more self-awareness and adaptability. I've come to understand what kind of structure helps me thrive and where I might need to create that structure for myself.
...
I loved walking to class, earbuds in, listening to the playlist of songs I wanted to perform to. I'd imagine which transitions would sync with which lyrics, where a drop might land most dramatically, or how a pose could stretch out just long enough to catch a musical swell. It was part puzzle, part daydream, part embodiment.

That spirit of creating within constraints is something I try to bring to my research, too. One of the paradoxically empowering and anxiety-inducing things about graduate school is the lack of structure. Every PhD experience is "the same" in that it's largely dependent on the individual. But learning to lean into that autonomy, to choreograph my own research journey, has helped me feel less overwhelmed by the unknown and more confident in what I can create.

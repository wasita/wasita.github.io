...
declare module '$env/static/private' {
	...
	export const CONDA_BACKUP_FORTRANFLAGS: string;
	...
	export const CONDA_BACKUP_FFLAGS: string;
	...
	export const CONDA_BACKUP_F95: string;
	export const CONDA_BACKUP_F77: string;
	...
	export const CONDA_BACKUP_F90: string;
	...
	export const CONDA_BACKUP_FC_FOR_BUILD: string;
	...
	export const CONDA_BACKUP_GFORTRAN: string;
	...
	export const CONDA_BACKUP_DEBUG_FFLAGS: string;
	...
	export const CONDA_BACKUP_DEBUG_FORTRANFLAGS: string;
	export const CONDA_BACKUP_CC: string;
	export const CONDA_DEFAULT_ENV: string;
	export const npm_config_user_agent: string;
	export const CONDA_BACKUP_FC: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MANPATH: string;
		CONDA_BACKUP_FORTRANFLAGS: string;
		...
		CONDA_BACKUP_F95: string;
		CONDA_BACKUP_F77: string;
		...
		rvm_proxy: string;
		CONDA_BACKUP_FC_FOR_BUILD: string;
		...
		TTY: string;
		PWD: string;
		CONDA_BACKUP_DEBUG_FFLAGS: string;
		...
		CONDA_BACKUP_DEBUG_FORTRANFLAGS: string;
		CONDA_BACKUP_CC: string;
		CONDA_DEFAULT_ENV: string;
		npm_config_user_agent: string;
		CONDA_BACKUP_FC: string;
